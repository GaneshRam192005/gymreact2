    ...
    <section className="w-11/12 z-10 lg:p-12 flex justify-center align-middle items-center mx-auto mt-10">
        <section className="grid grid-cols-2 gap-6  gap-y-10  md:grid-cols-2 lg:grid-cols-3 ">
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 16 (3).png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 17 (3).png" alt=""/></div>
                <div  className="content md:text-xl font-semibold text-sm"><p>SLOW MULTI + OMEGA</p></div>
                <div className="flex justify-between gap-5 pb-3 px-2 align-middle items-center">
                    <div className="text-sm md:text-2xl font-semibold">₹2,999</div>
                    <button className="bg-[#1C96C3] cursor-pointer rounded md:text-2xl text-white butt w-full">BUY NOW</button>
                </div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 18 (3).png" alt=""/></div>
                <div  className="content md:text-xl font-semibold text-sm"><p>LIVER DETOX</p></div>
                <div className="flex justify-between gap-5 pb-3 px-2 align-middle items-center">
                    <div className="text-sm md:text-2xl font-semibold">₹2,999</div>
                    <button className="bg-[#1C96C3] cursor-pointer rounded md:text-2xl text-white butt w-full">BUY NOW</button>
                </div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 16 (4).png" alt=""/></div>
                <div  className="content md:text-xl font-semibold text-sm"><p>SLOW MULTI-VITAMIN</p></div>
                <div className="flex justify-between gap-5 pb-3 px-2 align-middle items-center">
                    <div className="text-sm md:text-2xl font-semibold">₹2,999</div>
                    <button className="bg-[#1C96C3] cursor-pointer rounded md:text-2xl text-white butt w-full">BUY NOW</button>
                </div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 17 (4).png" alt=""/></div>
                <div  className="content md:text-xl font-semibold text-sm"><p>MULTITECH</p></div>
                <div className="flex justify-between gap-5 pb-3 px-2 align-middle items-center">
                    <div className="text-sm md:text-2xl font-semibold">₹2,999</div>
                    <button className="bg-[#1C96C3] cursor-pointer rounded md:text-2xl text-white butt w-full">BUY NOW</button>
                </div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/image.png" alt=""/></div>
            ...
            <section className=" px-2 w-[125px] md:w-[300px] rounded-2xl shadow-2xl lg:w-[300px] "data-aos="fade-up">
                <div className="max-w-[100%] object-cover mx-auto"><img className="w-full" src="images/Rectangle 18 (4).png" alt=""/></div>
